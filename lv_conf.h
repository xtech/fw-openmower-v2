...
#define LV_DPI_DEF 66 /**< [px/inch] 240*160 @ 99*57.5mm => 66 DPI */
...
#define LV_DRAW_SW_SUPPORT_ARGB8888 1 // AH20251124: Still needed for LVGL 9.4
...
#define LV_LOG_TRACE_OBJ_CREATE \
  1 /**< Enable/disable trace logs in object creation (core `obj` creation plus every widget). */
 ...
 *  - lv_roller_t      :  Options set to "Option 1", "Option 2", "Option 3", "Option 4", "Option 5", else no values are
 * set.
 ...
 * THEMES
 *==================*/
/* Documentation for themes can be found here:
 ...
 * LAYOUTS
 *==================*/
/* Documentation for layouts can be found here:
 * https://docs.lvgl.io/master/details/common-widget-features/layouts/index.html . */
 ...
 * OTHERS
 *==================*/
/* Documentation for several of the below items can be found here:
 * https://docs.lvgl.io/master/details/auxiliary-modules/index.html . */
...
#define LV_SDL_RENDER_MODE \
  LV_DISPLAY_RENDER_MODE_DIRECT /**< LV_DISPLAY_RENDER_MODE_DIRECT is recommended for best performance */
...
#if LV_USE_WAYLAND
#define LV_WAYLAND_BUF_COUNT \
  1 /**< Use 1 for single buffer with partial render mode or 2 for double buffer with full render mode*/
#define LV_WAYLAND_USE_DMABUF 0 /**< Use DMA buffers for frame buffers. Requires LV_DRAW_USE_G2D */
#define LV_WAYLAND_RENDER_MODE \
  LV_DISPLAY_RENDER_MODE_PARTIAL /**< DMABUF supports LV_DISPLAY_RENDER_MODE_FULL and LV_DISPLAY_RENDER_MODE_DIRECT*/
...
#define LV_WAYLAND_WINDOW_DECORATIONS \
  0 /**< Draw client side window decorations only necessary on Mutter/GNOME. Not supported using DMABUF*/
