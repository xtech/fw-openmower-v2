 ...
 *
 * Noticed that frexp and ldexp fit the format of the IEEE float representation,
 * so they should be quite fast. They are (more or less) equivalent with the
 * following:
 *
 ...
 * }
 *
 * 8388608.0 is 2^23, which scales the result to fit within 23 bits if sig_abs
 * < 1.0.
 *
